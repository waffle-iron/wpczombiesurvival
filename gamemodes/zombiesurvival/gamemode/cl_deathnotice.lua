...
killicon.AddFont("weapon_zs_oicw", "zsdeathnotice2", "f", color_white)
...
killicon.Add("weapon_zs_bloatedzombie", "zombiesurvival/killicons/fatzombie", color_white)
killicon.Add("weapon_zs_butcherknifez", "zombiesurvival/killicons/ghoul", color_white)
killicon.Add("weapon_zs_bonemesh", "zombiesurvival/killicons/creeper", color_white)
...
killicon.Add("weapon_zs_fleshcreeper", "zombiesurvival/killicons/flesh", color_white)
...
killicon.Add("weapon_zs_legion", "zombiesurvival/killicons/legion", color_white)
killicon.Add("weapon_zs_gigagorechild", "zombiesurvival/killicons/gorechild", color_white)
...
killicon.AddFont("weapon_zs_annihilator", "zsdeathnotice", "/", color_white)
...
killicon.AddFont("weapon_zs_laserboomstick", "zsdeathnotice", "0", color_white)
...
killicon.AddFont("weapon_zs_c4", "zsdeathnoticecs", "I", color_white)
...
killicon.AddFont("weapon_zs_galil", "zsdeathnoticecs", "v", color_white)
...
killicon.Add("weapon_zs_blaster", "killicon/remington", color_white)
