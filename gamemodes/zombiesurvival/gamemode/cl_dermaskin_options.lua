...
SKIN.PrintName = "ZS Options Derma Skin"
SKIN.Author = "ForrestMarkX"
SKIN.DermaVersion = 1
...
derma.DefineSkin("zombiesurvivaloptions", "The derma skin for the Zombie Survival Options menu", SKIN)
