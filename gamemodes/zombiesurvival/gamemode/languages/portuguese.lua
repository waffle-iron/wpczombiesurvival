...
LANGUAGE.not_enough_room_for_a_nest					 = "Não bastante espaço aqui para um ninho!"
LANGUAGE.too_close_to_another_nest					 = "Muito perto de outro ninho!"
LANGUAGE.nest_created								 = "Nest criada! Termine edifício para permitir a desova aqui."
LANGUAGE.nest_built_by_x							 = "Um ninho Flesh Creeper foi construído por %s e é agora um ponto de desova."
LANGUAGE.nest_destroyed								 = "Um ninho Flesh Creeper foi destruída."
LANGUAGE.wait_x_seconds_before_making_a_new_nest	 = "Você deve esperar %d mais segundos antes de criar um novo ninho."
LANGUAGE.too_close_to_a_human						 = "Muito perto de um ser humano!"
LANGUAGE.too_close_to_a_spawn						 = "Muito perto de uma desova de zumbis!"
LANGUAGE.x_has_built_this_nest_and_is_still_around	 = "%s construiu este ninho e ainda está por aí, então você não pode demoli-la."
LANGUAGE.no_other_nests								 = "Você não pode destruir um ninho se apenas um permanece."
...
LANGUAGE.description_butcher						 = "A, açougueiro morto-vivo enlouquecido. Não é muito difícil, mas ninguém o azar de estar perto dele provavelmente será despedaçado."
LANGUAGE.description_flesh_creeper					 = "Flesh Creepers possuem a capacidade de criar ninhos. \nA partir desses ninhos, outras criaturas zumbis emergir. \nA forma como isto funciona é desconhecida, mas é imperitive para destruir quaisquer ninhos ou trepadeiras."
...
LANGUAGE.controls_butcher							 = "> PRIMARIO: Costeleta"
LANGUAGE.controls_flesh_creeper						 = "> PRIMARIO: Cabeça Smash\n> SECUNDÁRIO: Ninho"
