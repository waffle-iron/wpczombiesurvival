...
LANGUAGE.not_enough_room_for_a_nest	= "No hay suficiente espacio aquí para un nido!"
LANGUAGE.too_close_to_another_nest = "Demasiado cerca de otro nido!"
LANGUAGE.nest_created = "Nido creado! Termine edificio para permitir el desove aquí."
LANGUAGE.nest_built_by_x = "Un nido Flesh enredadera ha sido construido por %s y ahora es un punto de desovar."
LANGUAGE.nest_destroyed	= "Un nido Flesh enredadera ha sido destruida."
LANGUAGE.wait_x_seconds_before_making_a_new_nest = "Debe esperar %d segundos más antes de crear un nuevo nido."
LANGUAGE.too_close_to_a_human = "Demasiado cerca de un ser humano!"
LANGUAGE.too_close_to_a_spawn = "Demasiado cerca de un engendro zombie!"
LANGUAGE.x_has_built_this_nest_and_is_still_around = "%s ha construido este nido y todavía está alrededor, por lo que no puede derribarlo."
LANGUAGE.no_other_nests = "No se puede destruir un nido si sólo uno permanece."
...
LANGUAGE.dont_have_weapon_x = "No se puede vender, no tiene un %s"
LANGUAGE.sold_x_for_y_points = "Vendido %s para los puntos de %d!"
...
LANGUAGE.class_flesh_creeper = "carne de la enredadera"
...
LANGUAGE.description_butcher = "A, carnicero-muertos enloquecido. No es muy difícil, pero nadie la mala suerte de estar cerca es muy probable que se rompa en pedazos."
LANGUAGE.description_flesh_creeper = "Flesh Enredaderas poseen la capacidad de crear nidos. \nA partir de estos nidos, otras criaturas zombies emergen. \nLa forma en que esto funciona es desconocida, pero es imperativa para destruir cualquier nidos o enredaderas."
...
LANGUAGE.controls_butcher = "> PRIMARIO: Picar"
LANGUAGE.controls_flesh_creeper	= "> PRIMARIO: Jefe de Smash\n> SECUNDARIO: Nido"
