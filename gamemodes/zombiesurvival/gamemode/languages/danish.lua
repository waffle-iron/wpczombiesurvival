...
LANGUAGE.not_enough_room_for_a_nest					= "Ikke nok plads her til en rede!"
LANGUAGE.too_close_to_another_nest					= "Alt for tæt på en anden reden!"
LANGUAGE.nest_created								= "Nest oprettet! Afslut bygning for at aktivere gydning her."
LANGUAGE.nest_built_by_x							= "En Flesh Creeper reden er bygget af% s og er nu en gyde point."
LANGUAGE.nest_destroyed								= "En Flesh Creeper reden er blevet ødelagt."
LANGUAGE.wait_x_seconds_before_making_a_new_nest	= "Du skal vente %d sekunder før du opretter en ny rede."
LANGUAGE.too_close_to_a_human						= "For tæt på et menneske!"
LANGUAGE.too_close_to_a_spawn						= "For tæt på en zombie gyde!"
LANGUAGE.x_has_built_this_nest_and_is_still_around	= "%s har bygget denne reden og er stadig omkring, så du kan ikke nedrive den."
LANGUAGE.no_other_nests								= "Du kan ikke ødelægge en rede hvis kun én tilbage."
...
LANGUAGE.description_butcher						= "En forrykte, udøde slagter. Det er ikke meget hård, men nogen uheldig at være i nærheden af det vil højst sandsynligt blive revet i stykker."
LANGUAGE.description_flesh_creeper					= "Flesh Creepers besidder evnen til at skabe reder. \nfra disse reder, andre zombified væsner dukke op. \nDen måde det fungerer, er ukendt, men det er imperitive at ødelægge eventuelle reder eller slyngplanter."
