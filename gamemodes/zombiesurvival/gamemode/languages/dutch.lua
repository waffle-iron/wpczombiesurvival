...
LANGUAGE.not_enough_room_for_a_nest					= "Niet genoeg ruimte hier voor een nest!"
LANGUAGE.too_close_to_another_nest					= "Te dicht bij een ander nest!"
LANGUAGE.nest_created								= "Nest gemaakt! Af te bouwen om hier te paaien in te schakelen."
LANGUAGE.nest_built_by_x							= "Een Flesh Creeper nest is gebouwd door %s en is nu een spawn point."
LANGUAGE.nest_destroyed								= "Een Flesh Creeper nest is vernietigd."
LANGUAGE.wait_x_seconds_before_making_a_new_nest	= "U moet %d seconden wachten voordat het creëren van een nieuw nest."
LANGUAGE.too_close_to_a_human						= "Te dicht bij een mens!"
LANGUAGE.too_close_to_a_spawn						= "Te dicht bij een zombie spawn!"
LANGUAGE.x_has_built_this_nest_and_is_still_around	= "%s heeft dit nest gebouwd en is nog steeds rond, dus je kunt niet slopen."
LANGUAGE.no_other_nests								= "U kunt een nest niet vernietigen als er maar één blijft."
...
LANGUAGE.description_butcher						= "Een krankzinnige, undead slager. Het is niet erg moeilijk, maar iedereen die ongelukkig genoeg om in de buurt het zal zeer waarschijnlijk worden aan flarden gescheurd."
LANGUAGE.description_flesh_creeper					= "Vlees Creepers beschikken over de mogelijkheid om nesten te maken. \nVanuit deze nesten, andere zombified wezens ontstaan. \nDe manier waarop dit werkt is onbekend, maar het is imperitive elke nesten of klimplanten vernietigen."
...
LANGUAGE.controls_butcher							= "> PRIMARY: Hakken"
LANGUAGE.controls_flesh_creeper						= "> PRIMARY: Head Smash\n> SECONDARY: Nest"
LANGUAGE.controls_gore_child						= "> PRIMARY: Klauwen"
LANGUAGE.controls_giga_gore_child					= "> PRIMARY: Intrappen\n> SECONDARY: Gooi Gore Child"
LANGUAGE.controls_zombine							= "> PRIMARY: Klauwen\n> SECONDARY: Grenade Zelfmoord"