...
LANGUAGE.not_enough_room_for_a_nest											= "Pas assez de place ici pour un nid!"
LANGUAGE.too_close_to_another_nest											= "Trop près d'un autre nid!"
LANGUAGE.nest_created														= "Nest créé! Terminer la construction pour permettre la ponte ici."
LANGUAGE.nest_built_by_x													= "Un nid Flesh Creeper a été construit par %s et est maintenant un point de spawn."
LANGUAGE.nest_destroyed														= "Un nid Flesh Creeper a été détruit."
LANGUAGE.wait_x_seconds_before_making_a_new_nest							= "Vous devez attendre %d secondes avant de créer un nouveau nid."
LANGUAGE.too_close_to_a_human												= "Trop près d'un humain!"
LANGUAGE.too_close_to_a_spawn												= "Trop près d'un spawn de zombie!"
LANGUAGE.x_has_built_this_nest_and_is_still_around							= "%s a construit ce nid et est toujours là, de sorte que vous ne peut pas démolir."
LANGUAGE.no_other_nests														= "Vous ne pouvez pas détruire un nid si un seul reste."
