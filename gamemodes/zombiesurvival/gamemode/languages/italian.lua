...
translate.AddLanguage("it", "Italian")
	...
	LANGUAGE.not_enough_room_for_a_nest								= "Non abbastanza spazio qui per un nido!"
	LANGUAGE.too_close_to_another_nest										= "Troppo vicino ad un altro nido!"
	LANGUAGE.nest_created													= "Nest ha creato! Termina edificio per consentire la deposizione delle uova qui."
	LANGUAGE.nest_built_by_x												= "Un nido Flesh Creeper è stato costruito da %s ed è ora un punto di spawn."
	LANGUAGE.nest_destroyed											= "Un nido Flesh Creeper è stato distrutto."
	LANGUAGE.wait_x_seconds_before_making_a_new_nest						= "È necessario attendere %d secondi prima di creare un nuovo nido."
	LANGUAGE.too_close_to_a_human											= "Troppo vicino a un essere umano!"
	LANGUAGE.too_close_to_a_spawn									= "Troppo vicino ad una progenie zombie!"
	LANGUAGE.x_has_built_this_nest_and_is_still_around				= "%s ha costruito questo nido ed è ancora in giro, quindi non si può demolirlo."
	LANGUAGE.no_other_nests													= "Non si può distruggere un nido se solo uno rimane."
	...
	LANGUAGE.dont_have_weapon_x										= "Non può vendere, non si dispone di un %s"
	LANGUAGE.sold_x_for_y_points									= "Venduto %s per %d punti!"
