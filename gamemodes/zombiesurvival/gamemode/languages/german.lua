...
LANGUAGE.not_enough_room_for_a_nest					= "Nicht genug Platz hier für ein Nest!"
LANGUAGE.too_close_to_another_nest					= "Zu nah an einem anderen Nest!"
LANGUAGE.nest_created								= "Nest geschaffen! Fertig bauen hier Laichen zu ermöglichen."
LANGUAGE.nest_built_by_x							= "A Flesh Creeper Nest wurde von% s gebaut und ist heute ein Spawnpunkt."
LANGUAGE.nest_destroyed								= "A Flesh Creeper Nest wurde zerstört."
LANGUAGE.wait_x_seconds_before_making_a_new_nest	= "Sie müssen %d Sekunden, bevor Sie ein neues Nest warten."
LANGUAGE.too_close_to_a_human						= "Zu nahe an einem Menschen!"
LANGUAGE.too_close_to_a_spawn						= "Zu nahe an einer Zombie Spawn!"
LANGUAGE.x_has_built_this_nest_and_is_still_around	= "%s hat dieses Nest gebaut und ist immer noch da, so kann man nicht zerstören es."
LANGUAGE.no_other_nests								= "Sie können ein Nest nicht zerstören, wenn nur einer bleibt."
