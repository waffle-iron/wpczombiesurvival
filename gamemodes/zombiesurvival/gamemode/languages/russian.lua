...
LANGUAGE.not_enough_room_for_a_nest					= "Не хватает места здесь для гнезда!"
LANGUAGE.too_close_to_another_nest					= "Слишком близко к другому гнездо!"
LANGUAGE.nest_created								= "Гнездо создан! Закончить строительство для того, чтобы нереста здесь."
LANGUAGE.nest_built_by_x							= "Плоть Creeper гнездо было построено% S и сейчас Спавнпоинт."
LANGUAGE.nest_destroyed								= "Плоть Creeper гнездо было уничтожено."
LANGUAGE.wait_x_seconds_before_making_a_new_nest	= "Вы должны ждать %d более секунд, прежде чем создавать новое гнездо."
LANGUAGE.too_close_to_a_human						= "Слишком близко к человеку!"
LANGUAGE.too_close_to_a_spawn						= "Слишком близко к зомби икру!"
LANGUAGE.x_has_built_this_nest_and_is_still_around	= "%s имеет встроенный это гнездо и до сих пор вокруг, так что вы не можете разрушить его."
LANGUAGE.no_other_nests								= "Вы не можете уничтожить гнездо, если только один остается."
...
LANGUAGE.description_legion							= "Угроза вашей общей неба Кадер, это зомби можно летать и пакеты тяжелый удар с его атак, а также и хуже, он принимает только половину повреждений от пуль."
