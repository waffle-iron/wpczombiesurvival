...
LANGUAGE.not_enough_room_for_a_nest					= "둥지 여기를하지 충분한 공간!"
LANGUAGE.too_close_to_another_nest					= "다른 둥지에 너무 가까이!"
LANGUAGE.nest_created								= "둥지가 만들어! 여기에 산란 수 있도록 건물을 마칩니다."
LANGUAGE.nest_built_by_x							= "육체 보았다 둥지 %의 의해 만들어진 지금은 스폰 포인트입니다되었습니다."
LANGUAGE.nest_destroyed								= "육체 보았다 둥지 파괴되었습니다."
LANGUAGE.wait_x_seconds_before_making_a_new_nest	= "새 둥지를 만들기 전에 %d 개 초 이상 기다려야합니다."
LANGUAGE.too_close_to_a_human						= "인간에 너무 가까이!"
LANGUAGE.too_close_to_a_spawn						= "좀비 스폰에 너무 가까이!"
LANGUAGE.x_has_built_this_nest_and_is_still_around	= "%s 은 (는)이 둥지를 구축하고 여전히 주위에, 그래서 당신은 그것을 파괴 할 수있다."
LANGUAGE.no_other_nests								= "하나만 남아 있다면 당신은 둥지를 파괴 할 수 있습니다."
