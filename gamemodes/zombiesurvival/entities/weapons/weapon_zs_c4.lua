...
if CLIENT then
	...
	SWEP.WElements = {
		["c4"] = { type = "Model", model = "models/weapons/w_c4.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-0.519, -0.519, -1.558), angle = Angle(-180, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
end
